...
export const SERVICES: ServiceWork[] = [
  ...
  },
  {
    ...
    name: "Review Replies",
    job: "Sound human",
    outcome: "Internal lane inside Review Power: drafts review replies in the client's voice while keeping risky replies approval-only.",
...
export const AGENT_SKILLS: AgentSkillProfile[] = [
  ...
  },
  {
    ...
    serviceOwners: ["Review Power", "Stay Found"],
  ...
  },
  {
    ...
    serviceOwners: ["Review Replies", "Review Power"],
  ...
  },
  {
    ...
    serviceOwners: ["Stay Found", "Review Power", "AI Ready Bundle"],
...
export const BOARD_TASKS: BoardTask[] = [
  ...
  },
  {
    ...
    reviewChecks: [
      "Get Found, Stay Found, Review Power, and AI Ready Bundle are the active offers",
  ...
  {
    title: "Run Review Power proof path",
    client: "GMF",
    service: "Review Power",
    agent: "Reviews Manager",
    reviewer: "Auditor",
    status: "In Progress",
    priority: "P0",
    due: "Before selling Review Power",
  ...
  {
    title: "Build AI Ready Bundle guardrails",
    client: "GMF",
    service: "AI Ready Bundle",
    agent: "Manager",
    reviewer: "Auditor",
    status: "Blocked / Later",
    priority: "P3",
    due: "Before selling AI Ready Bundle",
