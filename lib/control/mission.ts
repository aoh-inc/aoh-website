...
export const SERVICES: ServiceWork[] = [
  ...
  },
  {
    ...
    job: "Look active",
    outcome: "Fills stale social and website gaps before Reach sends new attention to the business.",
...
export const BOARD_TASKS: BoardTask[] = [
  ...
  },
  {
    ...
    reviewChecks: [
      "Define starter package: presence audit, 5 social posts, 1 blog, proof links",
