...
const products: ProductDetailData[] = [
  {
    ...
    price: "$99",
    cadenceLabel: "/mo",
    setup: "No setup fee",`r`n    promoNote: "First month $49 · code REVIEW50 · cancel anytime",`r`n    ctaLabel: "Start at $99/mo",`r`n    ctaHref: "https://pay.aioutsourcehub.com/review-automation-plan",`r`n    secondaryCtaHref: BOOKING_HREF,
