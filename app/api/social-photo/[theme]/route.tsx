...
const PHOTOS: Record<string, PhotoOverlay> = {
  "after-hours-payback": {
    ...
    ctaLabel: "AI Ready Bundle - $299/mo",
    ctaUrl: "getmefound.ai/pricing#ai-ready-bundle",
    accent: "green",
  },
  "star-sweet-spot": {
  ...
  "diy-vs-dfy": {
    ...
    ctaLabel: "Review Power - $149/mo",
    ctaUrl: "getmefound.ai/pricing#review-power",
    accent: "amber",
  },
  "software-vs-work": {
